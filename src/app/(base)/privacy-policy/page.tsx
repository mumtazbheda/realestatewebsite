...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy - Kingdom Capital",
  openGraph: {
    title: "Privacy Policy",
    description: "Privacy Policy - Kingdom Capital",
  },
...
const PrivacyPolicy = async () => {
  return (
    <main className="max-width sm:py-6 py-2.5 sm:px-4 px-2">
      <div className="flex flex-col-reverse gap-5 pb-4">
        {/* Title */}
        <div className="">
      ...
      <section
        className="
        w-full max-w-none prose lg:prose-lg md:prose-base prose-sm
        prose-h2:my-4
      ...
      >
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Kingdom Capital Real Estate LLC, AB
              centre - Office 513 - Sheikh Zayed Rd - Al Barsha - Al Barsha 1 -
              Dubai.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Kingdom Capital Real Estate,
              accessible from{" "}
              <a
                href="https://www.thekingdom.realestate/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.thekingdom.realestate/
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="!mt-9">Collecting and Using Your Personal Data</h2>
        ...
        <ul>
          <li>
            <p>By email: admin@thekingdom.ae</p>
          </li>
          <li>
            <p>By phone number: 800 MyKingdom</p>
          </li>
        </ul>
      </section>
    </main>
